...
public class Application extends JFrame{
	...
	private void initialize_privateKeyRingPanel(JPanel privateKeyRingPanel) {
		...
		this.privateKeyRingTableModel = this.initialize_keyRingTable(privateKeyRingPanel, columnLabels, deletePrivateKeyRingButton);
		
		this.privateKeyRingTableModel.addRow(new String[]{"16/05/2022 17:04", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST","potg4das13cxzz"});
		this.privateKeyRingTableModel.addRow(new String[]{"16/05/2022 17:05", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST","potg4das13cxzz"});
		this.privateKeyRingTableModel.addRow(new String[]{"16/05/2022 17:06", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST","potg4das13cxzz"});
	}
	...
	private void initialize_publicKeyRingPanel(JPanel publicKeyRingPanel) {
		...
		this.publicKeyRingTableModel = this.initialize_keyRingTable(publicKeyRingPanel, columnLabels, deletePublicKeyRingButton);
		
		this.publicKeyRingTableModel.addRow(new String[]{"16/05/2022 17:04", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST"});
		this.publicKeyRingTableModel.addRow(new String[]{"16/05/2022 17:05", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST"});
		this.publicKeyRingTableModel.addRow(new String[]{"16/05/2022 17:06", "ralt", "ABCD-1234","ABCD-EFGH-IJKL-MNOP-QRST"});
	}
	
	private DefaultTableModel initialize_keyRingTable(JPanel keyRingPanel, String[] columnLabels, JButton deleteKeyRingButton) {
